...
function selectSimulation(type) {
    ...
    switch(type) {
        case 'lapsandfolds':
            window.location.href = 'buckling-kinematics.html';
            break;
        case 'overfills':
            window.location.href = 'overfills.html';
            break;
        case 'underfills':
            window.location.href = 'underfills-case1.html';
            break;
        case 'multiple':
            window.location.href = 'multiple-defects.html';
            break;
    }
}
